function nirx_2homer(hdr, data, SD_filename)
% Code originally based on NIRx2nirs.m version 1.0 by Rob J Cooper, University College London, August 2013
% adapted for batch scripting and read/write functions of nirx_tools toolbox by 
% Don Rojas, Colorado State University

% NOTE: to create the required SD file, use script_csv2homerSD.m

% INPUTS:
%   hdr = from nirx_read_hdr.m
%   data = name, w/o extension of files to be found
