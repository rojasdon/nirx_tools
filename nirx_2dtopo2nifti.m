function [N, interpY] = nirx_2dtopo2nifti(S, fname, n)
% Project 3D MNI positions of fNIRS sensors onto 2D topography,
% interpolate channel-wise data, and then save results as NIfTI format
% note: code adapted from spm_fnirs_2dtopo.m, main differences in
% flexibility of not using contrast data and in using other than biosemi
% channel locations, original copyright: 
% Copyright (C) 2015 Wellcome Trust Centre for Neuroimaging
%
% author: Don Rojas, Ph.D.
% FORMAT N = nirx_2dtopo2nifti(S, fname, n) 
%
